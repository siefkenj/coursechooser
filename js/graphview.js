...
GraphviewCreator = (function() {
  ...
  GraphviewCreator.prototype.createGraphviewInstance = function(svgUrl) {
    ...
    onSvgLoadComplete = function(svgText) {
      ...
      return makeResizableAndClickable(parent.childNodes[0], graphviewDiv);
    };
    xhr = new XMLHttpRequest;
    xhr.onreadystatechange = function() {
      if (xhr.readyState === 4) {
        return onSvgLoadComplete(xhr.responseText);
      }
    };
  ...
  GraphviewCreator.prototype.replaceImage = function(imgElm) {
    ...
    afterTemplateLoads = function() {
      ...
      instance = _this.createGraphviewInstance(url);
      return imgElm.parentNode.replaceChild(instance, imgElm);
    };
    return this.loadTemplate('graphview.html', afterTemplateLoads);
  };
...
GraphManager = (function() {
  ...
  GraphManager.prototype.selectCourse = function(course) {
    ...
    return this.setCourseinfoVisibility(true);
  };
  ...
  GraphManager.prototype.deselectAll = function() {
    ...
    this.currentlySelected = null;
    return this.setCourseinfoVisibility(false);
  };
  ...
  GraphManager.prototype.setCourseinfoVisibility = function(visible) {
    ...
    if (visible) {
      ...
      return addClass(this.divGraph, 'sidepanel-visible');
    } else {
