...
var BasicCourse, CourseButton, CourseManager, CourseStateButton, CourseUtils, DiGraph, Electives, ElectivesButton, ElectivesButtonEditor, PrereqUtils, attachedToDom, dupObject, htmlEncode, objKeysEqual, objToString, objValsToArray, onPreviewPageShow, parseCourseListString, prepareNavMenu, prepareWelcomePage, reparent, showPage, symmetricDiffObjects, titleCaps,
...
$(document).ready(function() {
  ...
  */
  ...
  $('#show-courses').click(function() {
    var c, courses, createDisplayCallback, createErrorCallback, errorMsgHash, subjects, unknownCourses, v, _i, _j, _len, _len1, _ref, _results;
    errorMsgHash = {};
    subjects = {};
    courses = [];
    unknownCourses = [];
    try {
      _ref = parseCourseListString($('#department-list').combobox('value')), courses = _ref.courses, subjects = _ref.subjects, unknownCourses = _ref.unknownCourses;
    } catch (e) {
    ...
    _results = [];
    for (_j = 0, _len1 = unknownCourses.length; _j < _len1; _j++) {
      c = unknownCourses[_j];
  ...
  $('#hide-courses').click(function() {
    var c, courses, subjects, unknownCourses, v, _i, _len, _ref, _results;
    subjects = {};
    courses = [];
    unknownCourses = [];
    try {
...
DiGraph = (function() {
  ...
  DiGraph.prototype.toDot = function(name, titles, clusters, ops) {
    var alreadyAdded, c, clust, clusterYears, e, i, j, n, nodeId, ret, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4;
    if (titles == null) {
      titles = {};
    }
    if (clusters == null) {
    ...
    for (_l = 0, _len3 = _ref2.length; _l < _len3; _l++) {
      ...
      if (this.years) {
        ret += "\tsubgraph year" + i + " {\n";
        _ref3 = this.breakIntoTerms((function() {
          var _len4, _n, _ref3, _results;
          _ref3 = this.years[i];
          _results = [];
