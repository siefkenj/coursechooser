...
$(document).ready(function() {
  ...
  */
  ...
  $('#toggleEdge').click(function() {
    var edge, elm1, elm2, svgManager, updateSelected, _ref2;
    ...
    if (!(svgManager && svgManager.selected[0] && svgManager.selected[1])) {
      ...
      updateSelected = function() {
        ...
        return svgManager.select($("#" + (elm2.replace(' ', '-')))[0]);
      };
      return window.setTimeout(updateSelected, 1000);
    }
  });
  $('#makeCoreq').click(function() {
    var edge, elm1, elm2, svgManager, updateSelected;
    svgManager = window.courseManager.svgManager;
    if (!(svgManager && svgManager.selected[0] && svgManager.selected[1])) {
...
onPreviewPageShow = function() {
  var render;
  render = function() {
    var aspect, ast, dotCode, height, preview, svgManager, width, xdotCode;
...
CourseManager = (function() {
  ...
  CourseManager.prototype.initializeSVGManager = function(svgManager) {
    ...
    return this.svgManager.selectionChanged = function() {
      var course1, course2, edge, elm;
      ...
      $('#edge-selected .course1').html((course1 != null ? course1.$elm : void 0) || '');
      $('#edge-selected .course2').html((course2 != null ? course2.$elm : void 0) || '');
      if (!edge) {
        return $('#edge-selected .existing-edge').hide();
      } else {
        return $('#edge-selected .existing-edge').show();
      }
    };
  };
