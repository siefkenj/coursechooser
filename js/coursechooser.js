...
var BasicCourse, CourseButton, CourseManager, CourseStateButton, CourseUtils, DiGraph, Electives, ElectivesButton, PrereqUtils, attachedToDom, objToString, titleCaps,
...
CourseManager = (function() {
  ...
  CourseManager.prototype.createDotGraph = function() {
    var allCourses, allCoursesHash, c, course, courseHashLookup, e, edges, elms, g, hash, i, number, p, prereqs, subject, t, titles, years, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref;
    years = {
      1: [],
      2: [],
      3: [],
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = elms.length; _j < _len1; _j++) {
        ...
        if (this.sortableCourses[hash].state.required || this.sortableCourses[hash].state.elective) {
...
Electives = (function() {
  ...
  function Electives(data) {
    this.title = data.title, this.requirements = data.requirements, this.courses = data.courses;
...
ElectivesButton = (function(_super) {
  ...
  ElectivesButton.prototype.update = function(data) {
    ...
    return this.$elm.find('.requirement').html("At least " + this.requirements.units + " " + this.requirements.unitLabel);
  };
