...
var BasicCourse, CourseButton, CourseManager, CourseStateButton, CourseUtils, DownloadManager, Electives, ElectivesButton, ElectivesButtonEditor, FileHandler, Graph, PrereqUtils, SVGGraphManager, attachedToDom, dupObject, escapeJSON, htmlEncode, localStorageWrapper, objKeysEqual, objToString, objValsToArray, onPreviewPageShow, parseCourseListString, parseUrlHash, prepareNavMenu, prepareWelcomePage, reparent, showPage, strWidthInEn, symmetricDiffObjects, titleCaps, updatePreview, updateWelcomePage,
...
localStorageWrapper = function(action, data) {
  ...
  return $.jStorage.set('coursechooser', data);
};
...
SVGGraphManager = (function() {
  ...
  function SVGGraphManager(svgGraph, graphState) {
    ...
    this.$svg.find('.node').click(function(event) {
      ...
      if (elm.isElectivesNode) {
        ...
        return _this.electivesNodeClicked(course.cluster);
      } else {
        course = _this.graphState.nodes[elm.courseHash];
        return _this.courseClicked(course.course);
      }
    });
  ...
  SVGGraphManager.prototype.addReferenceToCourseToNodes = function() {
    ...
    for (hash in this.graphState.clusters) {
      ...
      if (elm) {
        elm.courseHash = hash;
        _results.push(elm.isElectivesNode = true);
      } else {
  ...
  SVGGraphManager.prototype.electivesNodeClicked = function(course) {
    ...
    clickedNode = $("#" + (sanitizeId(BasicCourse.hashCourse(course))))[0];
    this.deselectAll();
    return this.select(clickedNode, true);
  };
  ...
  SVGGraphManager.prototype.highlightPrereqPath = function(course) {
    ...
    return highlight("#" + course.subject + "-" + course.number);
  };
...
CourseManager = (function() {
  ...
  CourseManager.prototype.bindElectivesDescription = function(course) {
    ...
    $('#electives-description')[0].onkeyup = function() {
      return window.setTimeout(descriptionChange, 0);
    };
    return $('#electives-url')[0].onkeyup = function() {
      return window.setTimeout(urlChange, 0);
    };
  };
...
Graph = (function() {
  ...
  Graph.prototype.toJSON = function(stringify) {
    var c, cluster, edge, elective, node, obj, ret, _, _base, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    if (stringify == null) {
      stringify = true;
    }
    ret = {
    ...
    for (_ in _ref4) {
      ...
      if ((_ref5 = elective.data) != null ? _ref5.description : void 0) {
        obj.cluster.data.description = elective.data.description;
      }
      if ((_ref6 = elective.data) != null ? _ref6.url : void 0) {
